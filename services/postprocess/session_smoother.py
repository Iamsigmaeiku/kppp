...
from services.postprocess.rts_smoother import SmoothInput, SmoothOutput, smooth_track
...
async def smooth_session(
    ...
    *,
    ...
    _write_outputs(cfg, session_id=session_id, device_id=device_id, outputs=outputs)
    logger.info(
